...
<head>
    ...
    <style>
        .card {
            background: linear-gradient(135deg, #79dcf8, rgb(255 255 255));
            padding: 20px;
            border-radius: 10px;
            box-shadow: 0 0 10px rgb(40 47 42 / 20%);
        }
    </style>
</head>
                        ...
                        <div class="app-brand justify-content-center mb-4 mt-2">
                            <a href="index.html" class="app-brand-link gap-2">
                                <span class="app-brand-logo ">
                                    <img src="{{asset('assets\img\icons\brands\onmedium_temp.png')}}" alt="" srcset="" height="100" width="120" round_circle>
                                </span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-1 pt-2">Welcome to OnMediums</h4>
                        <div>
                            @if ($errors->any())
