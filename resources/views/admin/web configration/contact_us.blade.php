...
<div class="row">
    ...
    <div class="col-12 mb-4">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <h2>Contact us for <b>OnMediums</b></h2>

                    <p>Welcome to <b>OnMediums</b>, if you want to contact us, then feel free to say anything about <b>https://onmediums.com</b>. We'll appreciate your feedback.</p>
                    ...
                    - If you want to give suggestions to improve <b>OnMediums</b><br />
