...
@section('title')
Hex To Text Generator || Hex To Text Convertor || Convertor Case
@endsection
@section('content-main')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="{{route('indexDashboard')}}">Home /</a></span><span class="text-muted fw-light"><a href="{{route('allcodeDatatransalator')}}">All Coding & Data Translation Tools/</a></span>Hex To Text Convertor</h4>
<div class="row">
    <!-- Full Editor -->
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-xl-6 col-xxl-6 col-md-12 col-sm-12">
                        ...
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            <textarea name="generated-description" class="form-control form-control-lg" cols="30" rows="10" id="generated-text" contenteditable="true" placeholder="45 6e 74 65 72 20 59 6f 75 72 20 54 65 78 74"></textarea>
                        </fieldset>
                        <p class="text-center">
