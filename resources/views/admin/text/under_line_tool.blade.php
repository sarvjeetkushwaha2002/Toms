...
@section('title')
Underline Text Generator || Onlne Underline Text Generator ||
@endsection
@section('content-main')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="{{route('indexDashboard')}}">Home /</a></span><span class="text-muted fw-light"><a href="{{route('indexTextEditorall')}}">All Text Modification Formatting Tools/</a></span>Underline Text Generator</h4>
<div class="row">
    <!-- Full Editor -->
    <div class="col-12 mb-4">
        <div class="card">
            <h5 class="card-header text-center">Underline Text Generator By <a href="{{route('indexDashboard')}}" class="fw-semibold">OnMediums</a></h5>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-xl-6 col-xxl-6 col-md-12 col-sm-12">
                        ...
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            <textarea name="generated-description" class="form-control form-control-lg" cols="30" rows="10" id="generated-text" contenteditable="true" placeholder="E̲n̲t̲e̲r̲ Y̲o̲u̲r̲ T̲e̲x̲t̲"></textarea>
                        </fieldset>
                        <p class="text-center">
        ...
        <div class="card">
            <div class="card-header text-center">
                <div class="card-title mb-0 text-center">
                    <h5 class="mb-0 ">How To Use Underline Text Generator By <a href="{{route('indexDashboard')}}" class="fw-semibold">OnMediums</a></h5>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-title mb-0">
                            <h5 class="mb-0">Underline Text Generator</h5>
                            <small>Enter Value Automatic Generator </small><br><br>
                            <p><b>1.</b>You mentioned that when a value is entered in the "Enter your text" 'Enter your text' textarea, the text will be generated in Reverse text formats 'E̲n̲t̲e̲r̲ Y̲o̲u̲r̲ T̲e̲x̲t̲' in the second textarea. <br><br>
                                <b>2.</b>To convert your text into an underlined font, use this easy and free online Underline Text Generator. Just type the words you want to be converted into underlined text in the left-hand field of the generator. As you type, you will see the font transform into underlined text on the right. When you're finished, copy the underlined text and paste it wherever you need it.
                            </p>
                        </div>
                    </div>
                </div>
