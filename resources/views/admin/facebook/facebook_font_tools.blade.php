...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="{{route('indexDashboard')}}">Home /</a></span><span class="text-muted fw-light"><a href="{{route('indexTextEditorall')}}">All Text Modification Formatting Tools/</a></span>Social Media(Facebook,WhatsApp,Instagram) Text Generator</h4>
<div class="row">
    <!-- Full Editor -->
    <div class="col-12 mb-4 ">
        <div class="card">
            <h5 class="card-header text-center">Social Media(Facebook,WhatsApp,Instagram) Text Generator By <a href="{{route('indexDashboard')}}" class="fw-semibold">Tech Onmediums</a></h5>
            <div class="card-body">
                <div class="row">
        ...
        <div class="card">
            <div class="card-header text-center">
                <div class="card-title mb-0 text-center">
                    <h5 class="mb-0 ">How To Use Social Media(Facebook,WhatsApp,Instagram) Text Generator By <a href="{{route('indexDashboard')}}" class="fw-semibold">Tech Onmediums</a></h5>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
