...
@section('title')
Online Slugify Url Text Generator || Slugify Url Text Generator || Convert Case
@endsection
@section('content-main')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="{{route('indexDashboard')}}">Home /</a></span><span class="text-muted fw-light"><a href="{{route('indexTextEditorall')}}">All Text Modification Formatting Tools/</a></span>Slugify Url Text Generator</h4>
<div class="row">
    <!-- Full Editor -->
    <div class="col-12 mb-4">
        <div class="card">
            <h5 class="card-header text-center">Slugify Url Text Generator By <a href="{{route('indexDashboard')}}" class="fw-semibold">OnMediums</a></h5>
            <div class="card-body">
                <div class="row">
        ...
        <div class="card">
            <div class="card-header text-center">
                <div class="card-title mb-0 text-center">
                    <h5 class="mb-0 ">How To Use Slugify Url Text Generator By <a href="{{route('indexDashboard')}}" class="fw-semibold">OnMediums</a></h5>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-title mb-0">
                            <h5 class="mb-0">Slugify Url Text Generator</h5>
                            <small>Enter Value Automatic Generator slug url Text</small><br><br>
                            <p><b>1.</b>You mentioned that when a value is entered in the
                                ...
                                <b>2.</b>If you want to convert text to a slug url and save time by using a Slugify Url Text Generator tool
                            </p>
                        </div>
                    </div>
                </div>
