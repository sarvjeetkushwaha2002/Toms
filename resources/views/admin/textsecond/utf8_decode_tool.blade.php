...
@section('title')
Online UTF-8 Encode to UTF-8 Decode Converter || UTF-8 Encode to UTF-8 Decode Converter || Convert Case
@endsection
@section('content-main')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="{{route('indexDashboard')}}">Home /</a></span><span class="text-muted fw-light"><a href="{{route('allcodeDatatransalator')}}">All Coding & Data Translation Tools/</a></span>UTF-8 Encode to UTF-8 Decode Converter</h4>
<div class="row">
    <!-- Full Editor -->
    <div class="col-12 mb-4">
        <div class="card">
            <h5 class="card-header text-center">UTF-8 Encode to UTF-8 Decode Converter By <a href="{{route('indexDashboard')}}" class="fw-semibold">OnMediums</a></h5>
            <div class="card-body">
                <div class="row">
        ...
        <div class="card">
            <div class="card-header text-center">
                <div class="card-title mb-0 text-center">
                    <h5 class="mb-0 ">How To Use UTF-8 Encode to UTF-8 Decode Converter By <a href="{{route('indexDashboard')}}" class="fw-semibold">OnMediums</a></h5>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-title mb-0">
                            ...
                            <small>Enter Value Automatic utf-8 encode convert utf-8 decode</small><br><br>
                            <p><b>1.</b>You mentioned that when a value is entered in the "\u0045\u006e\u0074\u0065\u0072\u0020\u0059\u006f\u0075\u0072\u0020\u0054\u0065\u0078\u0074" textarea, the text will be generated in text formats'Enter Your Text' in the second textarea. <br><br>
                                <b>2.</b>If you want to convert utf-8 encode to utf-8 decode a and save time by using a UTF-8 Encode to UTF-8 Decode Converter tool
                            </p>
                        </div>
                    </div>
                </div>
