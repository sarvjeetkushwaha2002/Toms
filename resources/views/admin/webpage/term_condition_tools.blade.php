...
@section('title')
Terms & Conditions Generator || Online Free Terms & Conditions Generator || Website Page Terms & Conditions Generator||
@endsection
@section('content-main')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="{{route('indexDashboard')}}">Home /</a><a href="{{route('allcodeDatatransalator')}}">All Coding & Data Translation Tools/</a></span>Online Free Terms & Conditions Generator</h4>
<div class="row">
    <!-- Full Editor -->
    <div class="col-12 mb-4">
        <div class="card">
            <h5 class="card-header text-center">Online Free Terms & Conditions Generator By <a href="{{route('indexDashboard')}}" class="fw-semibold">Tech Onmediums</a></h5>
            <div class="card-body">
                <div class="row">
                        ...
                        <div class="d-flex align-items-center justify-content-center ">
                            ...
                            <form class=" border rounded p-3 p-md-5" id="sendbydata">
                                ...
                                <div class="d-grid gap-2">
                                    <button type="button" class="btn btn-primary waves-effect waves-light" id="termsConditions">Generate Terms & Conditions</button>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <div class="card">
            <div class="card-header text-center">
                <div class="card-title mb-0 text-center">
                    <h5 class="mb-0 ">How To Use Online Free Terms & Conditions Generator By <a href="{{route('indexDashboard')}}" class="fw-semibold">Tech Onmediums</a></h5>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-title mb-0">
                            <h5 class="mb-0">Online Free Terms & Conditions Generator</h5>
                            <small>Fill The Form and Click the Button after Generator Terms & Conditions </small><br><br>
                            <p><b>1.</b>First, you will fill out the form, then click on the "Generate Terms & Conditions" button and wait. <br><br>
                                <b>2.</b>First, you will fill out the form and then click on the "Generate Terms & Conditions" button and wait. If you have filled it out correctly, you will see a textarea box with HTML code, and you can copy what you need.
                            </p>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        $('#button-1').hide();
        $(document).on('click', '#termsConditions', function() {
            var formData = $("#sendbydata").serialize();
            var newurl = "{{ route('createTermsCondition') }}";
            $.ajax({
                url: newurl,
                type: 'post',
                data: formData,
