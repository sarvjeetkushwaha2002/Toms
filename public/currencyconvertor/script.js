...
function getExchangeRate() {
    ...
    let url = 'http://api.exchangeratesapi.io/v1/convert?access_key=d8c32553e384881fbc6a17cfbf329195&from= ${fromCurrency.value}& to = ${toCurrency.value}& amount = ${amountVal}';
    // console.log(url);
